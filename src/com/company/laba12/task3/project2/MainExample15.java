package com.company.laba12.task3.project2;
...
public class MainExample15 {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        File f1 = new File("src/com/company/laba12/task3/project2/filmInfo.txt");
        File f2 = new File("src/com/company/laba12/task3/project2/rusFilmInfo.txt");
