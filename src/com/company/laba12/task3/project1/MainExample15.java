package com.company.laba12.task3.project1;
...
public class MainExample15 {
    public static void main(String[] args) {
        try {
            File f1 = new File("src/com/company/laba12/task3/project1/films.txt");
            if (!f1.exists()) f1.createNewFile();
            File f2 = new File("src/com/company/laba12/task3/project1/rusFilms.txt");
